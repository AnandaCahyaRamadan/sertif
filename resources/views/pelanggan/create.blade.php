            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nomor_hp') is-invalid @enderror" id="exampleInputHp" placeholder="Masukkan Nomor HP" name="nomor_hp" value="{{old('nomor_hp')}}">
